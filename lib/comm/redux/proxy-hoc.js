    ...
    return function proxyHOC(WrappedComponent) {
        ...
        return _temp = _class = function (_Component) {
            ...
            function ProxyConnect() {
                ...
                _this.state = {
                    id: undefined,
                    wantedState: wanted ? wanted.reduce(function (acc, el) {
                ...
                _this.progressor = function (aArg) {
                    ...
                    if (__PROGRESS) {
                        ...
                        _this.setState(function (_ref) {
                            var idOld = _ref.id;
                            return idOld === undefined ? { id: id, wantedState: wantedState } : { wantedState: wantedState };
            ...
            (0, _createClass3.default)(ProxyConnect, [{
                ...
                value: function render() {
                    ...
                    if (wanted) {
                        ...
                        return _react2.default.createElement(WrappedComponent, (0, _extends3.default)({}, this.props, { dispatchProxied: dispatchProxied }, wantedState));
                    }
                }
            }]);
            return ProxyConnect;
