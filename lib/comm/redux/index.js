...
var _all = require('cmn/lib/all');

var _recompose = require('cmn/lib/recompose');
        ...
        this.render = function () {
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)((0, _keys2.default)(state)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (!(0, _recompose.depth0Or1Equal)(state[key], stateOld[key])) changed[key] = true; // as in server side, i can do reference checking, as i am careful in the reducers to return the same state if no change is needed
            ...
            if (didWantedChange(['elements'], changed)) {
                ...
                console.log('removeElement:', _this.removeElement, 'ids:', elementIds);
