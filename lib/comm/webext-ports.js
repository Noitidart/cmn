...
var Server = exports.Server = function (_Base) {
    ...
    function Server(aMethods, onHandshake) {
        ...
        _this.connector = function (aPort) {
            console.log('Comm.' + _this.commname + ' - incoming connect request, aPortGroupName:', aPort.name, 'aPort:', aPort);
        ...
        _this.disconnector = function (aPort) {
            console.log('Comm.' + _this.commname + ' - incoming disconnect request, static aPort:', aPort, 'portid:', _this.getPortId(aPort));
...
var Client = exports.Client = function (_Base2) {
    ...
    function Client(aMethods) {
        ...
        _this2.disconnector = function (aPort) {
            console.log('Comm.' + _this2.commname + ' - incoming disconnect request, aPort:', aPort);
