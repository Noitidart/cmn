...
var TRUNK = typeof chrome !== 'undefined' && chrome.runtime ? chrome : browser;
...
window.extensiona = function (dotpath) {
    for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        args[_key - 1] = arguments[_key];
    }

    var basepath = dotpath.split('.');
    basepath.pop();
    basepath = basepath.join('.');
    ...
    return new _promise2.default(function (resolve) {
        return (0, _all.deepAccessUsingString)(TRUNK, dotpath).apply(undefined, args.concat([resolve]));
    });
